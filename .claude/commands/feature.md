...
- If this feature is dependent on changes to another project, it may help to look at that project's files to see the latest developments there.

## Relevant Files

Focus on the following files:
- `README.md` - Contains the project overview and instructions.
- `src/**` - Contains the codebase of this testing framework
- `tests/**` - Contains the tests that this testing framework is built to run
- `runs/**` - Contains the run artifacts that were created upon testing
- `~/ai/standard-configuration/**` - Contains the project we're checking out and testing
- `~/ai/standard-configuration/src/claude/commands/**` - Contains the slash commands of the project we're checking out and testing
- `~/ai/standard-configuration/src/adws/**` - Contains the ADWs of the project we're checking out and testing
